...
const OrderCard = () => {
    return (
        <div className="w-[500px] bg-[#262626] p-4 rounded-lg mb-4">
            ...
            <div className="flex items-center flex justify-between w-[100%]">
            ...
            <div className="flex items-center justify-between mt-4 text-[#ababab]">
                <p>September 24, 2026 06:09 PM</p>
                <p>8 Items</p>
            </div>
            <hr className="w-full mt-4 border-t-1 border-gray-500"/>
            <div className = "flex items-center justify-between mt-4">
                <h1 className= "text-[#f5f5f5] text-lg font-semibold">Total</h1>
                <p className="text-[#f5f5f5] text-lg font-semibold tracking-wide">$ 150.00</p>
            </div>
